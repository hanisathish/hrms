...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.admin', 'auth.screenlock', 'plan.null'], 'prefix' => 'admin'], function () {
    ...
    //All employees
    Route::get('employees/allemployees', ['as' => 'admin.employees.all_employees', 'uses' => 'EmployeesController@allEmployees']);
    Route::get('employees/ajax_all_employees/', ['as' => 'admin.ajax_all_employees', 'uses' => 'EmployeesController@ajax_all_employees']);
    ...
    //Admin Employee attendance roster update 
    Route::post('attendance-roster/filter', ['as'=>'admin.attendance-roster.filter','uses'=>'AttendanceRosterController@filterAttendanceRoster']);
    // Route::get('attendances-employee', ['as'=>'admin.attendance.employee','uses'=>'AttendanceRosterController@attendanceEmployee']);
    Route::resource('attendance-roster', 'AttendanceRosterController', ['as' => 'admin']);

    // Route::get('attendance-roster', ['as'=>'admin.attendance_roster.index','uses'=>'AttendanceRosterController@index']);
