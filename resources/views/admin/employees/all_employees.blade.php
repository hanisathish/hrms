...
@section('mainarea')
    ...
    <div class="page-head">
        <div class="page-title"><h1>
                All {{ trans('pages.employees.indexTitle') }}
            </h1></div>
    </div>
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">All {{ trans('pages.employees.indexTitle') }}</span>
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            <div class="dashboard-stat yellow-lemon">
                ...
                <div class="details">
                    ...
                    <div class="desc">
                        Serving Notice Period Employees
                    </div>
                </div>
...
@section('footerjs')
    ...
    <script>
        ...
        var table = $('#sample_employees').dataTable({
            ...
            processing: true,
            serverSide: true,
            "ajax": "{{ route("admin.ajax_all_employees") }}",
            "autoWidth": false,
            "aaSorting": [[7, "desc"]],
            columns: [
        ...
        function sendJoiningLetter(id, name) {

            $('#commonModal').modal('show');

            var confirmMsg = '{!! trans('messages.sendConfirm', ["name" => ":name"]) !!}';
            confirmMsg = confirmMsg.replace(":name", name);

            $("#commonModal").find('#info').html(confirmMsg);

            $('#commonModal').find("#delete").off().click(function () {
