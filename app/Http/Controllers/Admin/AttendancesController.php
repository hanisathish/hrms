...
class AttendancesController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $this->employees = Employee::manager()
            ...
            return View::make('admin.attendances.attendance-sheet-all', $this->data);
        //old return View::make('admin.attendances.attendance-sheet', $this->data);
    }
...
as a'), "a.employee_id", "=", "employees.id")
    ...
    public function filterAttendance(Request $request)
    {
        ...
        $view = View::make('admin.attendances.load-all', $this->data)->render();
